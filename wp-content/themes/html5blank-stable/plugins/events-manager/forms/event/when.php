...
<div class="event-form-when" id="em-form-when">
	...
	<p class="em-time-range">
		...
		<?php _e('Todo el dia','events-manager'); ?> <input type="checkbox" class="em-time-all-day" name="event_all_day" id="em-time-all-day" value="1" <?php if(!empty($EM_Event->event_all_day)) echo 'checked="checked"'; ?> />
	</p>
	...
	<?php esc_html_e( 'Este evento aparece cada dia entre el comienzo y el final de la fecha, con el comienzo/fin de hora aplicados para cada día.', 'events-manager'); ?>
	</span>
</div>  
