...
<p>#_LOCATIONNEXTEVENTS</p>',
        ...
        'dbem_data_privacy_consent_text' => esc_html__('Doy consentimiento que mis datos suministrados son coleccionados y guardados como se ha indicado por la página %s.','events-manager'),
